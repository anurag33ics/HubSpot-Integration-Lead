...
* {
 ...
 /*@import url('font/InterTight-Regular.ttf');*/
        ...
        <div class="panels">
            <div class="panel" id="one-panel">
                <div class="panel-title" id='deal1'>
                        ...
                        <div class='col-md-2'>
                            Top Priority Deals
                            <a onclick="exportTableToExcel('toppriority','Top-Priority')"> <img src="file-export-solid.svg" style='cursor: pointer;' width="20px"/></a>
                            <i class="fa-solid fa-file-pdf" onclick="generatePDF()"></i>
                        </div>
                        <div class='col-md-2'>
                ...
                <div class="panel-title" id='deal2'>
                    <div class="row" >
                        <div class='col-md-3'>
                            ...
                            <a onclick="exportTableToExcel('newcompany','New-Company')"> <img src="file-export-solid.svg" style='cursor: pointer;' width="20px"/></a>
                        </div>
                        <div class='col-md-2'>
                ...
                <div class="panel-title" id="deal3">
                    <div class="row" >
                        <div class='col-md-4'>
                            ...
                            <a onclick="exportTableToExcel('generalpipeline','General-Pipeline')"> <img src="file-export-solid.svg" style='cursor: pointer;' width="20px"/></a>
                        </div>
                        <div class='col-md-2'>
                ...
                <div class="panel-title" id="deal4">
                    <div class="row" >
                        <div class='col-md-3'>
                            ...
                            <a onclick="exportTableToExcel('allpipeline','All-pipeline')"> <img src="file-export-solid.svg" style='cursor: pointer;' width="20px"/></a>
                        </div>
                        <div class='col-md-2'>
      ...
      <div class="cv-spinner">
        ...
        ajaxStop: function(){ 
            ...
            $("#logout").on("click", function(){
                ...
                if(cnf){
                    $.ajax({
                    url: 'ajax-aman.php?action=logout',
                    method: "POST",
                    data: {         },
            ...
            $("#submit").on("click", function() {
                ...
                if(date!='' && objname!='' && date2!='' ){
                    $.ajax({
                    url: 'ajax-aman.php?action=comparedata',
                    method: "POST",
                    data: {
        ...
        <script>
                ...
                if(color!='white' && color!='#16efda'){
                    $.ajax({
                        url: 'ajax-aman.php?action=getDiffData',
                        method: "POST",
    ...
    function exportToPDF() {
      ...
      const table = document.getElementById('toppriority');
      var rows = table.getElementsByTagName('tr');
      const tableWidth = 900; // Adjust according to your table size
      const tableHeight = 200; // Adjust according to your table size
      ...
      doc.autoTable({ html: table, startY: marginY, margin: { left: marginX, right: marginX } });
...
function generatePDF() {
    const element = document.getElementById("toppriority");
    const tableRows = element.querySelectorAll("tr");
    
    // Apply CSS to ensure each table row stays on one page
...
function downloadCode() {
    var x = document.getElementById("toppriority");
    generatePDF();
